...
public class LicenseAssignmentResponse {
    ...
    public LicenseAssignmentResponse() {
    }

    public LicenseAssignmentResponse(Integer assignmentId, Integer licenseId, String licenseKey, String softwareName,
                                   Integer userId, String userName, String userEmail, LocalDate assignedDate,
                                   LocalDate unassignedDate, String status) {
